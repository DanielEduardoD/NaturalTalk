...
- Taiwan Traditional Chinese has different vocabulary: 可以 vs 可以, but also unique words like 超 (super), 好棒 (great).`,
  ...
  es: {
    ...
    isRTL: false,
    dialects: [
      { code: 'mexican-north', label: 'Northern Mexican (Coahuila, Nuevo León, Chihuahua, Sonora)' },
      { code: 'mexican-central', label: 'Central Mexican (CDMX, Puebla, Bajío)' },
      { code: 'mexican-west', label: 'Western Mexican (Jalisco, Michoacán)' },
      { code: 'mexican-coastal', label: 'Coastal / Southeast Mexican (Veracruz, Yucatán)' },
      { code: 'colombian', label: 'Colombian Spanish' },
      { code: 'argentina', label: 'Argentine Spanish (voseo)' },
      { code: 'rioplatense-uy', label: 'Uruguayan Spanish (voseo)' },
      { code: 'chilean', label: 'Chilean Spanish' },
      { code: 'peruvian', label: 'Peruvian Spanish' },
      { code: 'caribbean', label: 'Caribbean Spanish (Cuba, PR, Dominican Rep.)' },
      { code: 'centroamerica', label: 'Central American Spanish' },
      { code: 'spain', label: 'Spanish (Spain — Peninsular)' },
      { code: 'andalusian', label: 'Andalusian Spanish' },
      { code: 'latam-general', label: 'Latin American (general / neutral)' },
    ],
