...
function Onboarding() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col px-5 py-8">
      ...
      <p className="mt-4 text-xs tracking-wide text-muted-foreground uppercase">Step {step} of 3</p>
      ...
      {step === 3 ? (
        <div className="mt-3 space-y-6">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            NaturalTalk translates with built-in AI out of the box — nothing to configure. Your
            conversations, profiles and saved words stay on this device.
          </p>
      ...
      <div className="mt-auto flex gap-3 pt-10">
        ...
        <button
          type="button"
          disabled={step === 1 && !draft.nativeLanguage}
